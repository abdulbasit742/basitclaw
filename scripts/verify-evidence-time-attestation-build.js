...
await requireMarkers('src/evidence/evidenceVerificationBundleServer.js', 'Time-attestation outer composition', [
...
await requireMarkers('test/evidenceTimeAttestationServer.test.js', 'Time-attestation startup safeguard', [
  'enabled time attestations cannot start without immutable preservation'
]);
