...
const requiredFiles = [
  'src/evidenceRuntime.js', 'src/evidence/evidenceCrypto.js', 'src/evidence/evidenceRegistry.js',
  'src/evidence/evidenceHandler.js', 'src/evidence/evidenceServer.js', 'scripts/evidence-check.js',
  'src/types/evidence.d.ts', 'docs/evidence-chain-of-custody.md', 'test/evidenceRegistry.test.js',
  'test/evidenceServer.test.js', 'public/workforce-audit.html'
];
...
await markers('src/evidence/evidenceRegistry.js', [
  'EVIDENCE_INTEGRITY_FAILED', 'assertUsableReferences', 'evidence.disposition_committed',
  'purgePending', 'RELEASE HOLD', 'DISPOSE'
]);
await markers('src/evidence/evidenceHandler.js', [
  '/api/workforce-audit/evidence', 'x-evidence-sha256', 'backup:restore',
  'referencedByFindings', 'EVIDENCE_STORE_BUSY', 'evidenceTransportLimit'
]);
await markers('src/evidence/evidenceServer.js', [
  'PassThrough', '/api/workforce-audit/findings', 'prepareEvidenceLifecycle',
  'createEvidenceReferenceMutex', 'EVIDENCE_REFERENCE_BUSY'
]);
