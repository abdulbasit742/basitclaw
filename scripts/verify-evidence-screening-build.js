...
await requireMarkers('src/evidence/evidenceScreeningEngine.js', 'Screening engine', [
  'MALWARE_EICAR_TEST_SIGNATURE', 'DLP_PRIVATE_KEY_MATERIAL', 'CONTENT_TYPE_EXTENSION_MISMATCH',
  'CONTAINER_REQUIRES_DEEP_SCAN', 'wouldQuarantine', 'WORKFORCE_AUDIT_EVIDENCE_SCREENING_MODE'
]);
await requireMarkers('src/evidence/evidenceScreeningRegistry.js', 'Screening registry', [
  'encryptEvidenceJson', 'EVIDENCE_QUARANTINED', 'RELEASE QUARANTINE', 'REJECT EVIDENCE',
  'screening.quarantine_released', 'assertVersionAccessible'
]);
await requireMarkers('src/evidence/evidenceHandler.js', 'Screening API', [
  '/screening', 'screeningEvents', 'releaseQuarantine', 'rejectQuarantine', 'evidence.quarantine_released'
]);
