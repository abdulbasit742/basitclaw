...
await requireMarkers('src/evidenceRuntime.js','Composed evidence runtime',['createEvidenceTimeAttestationRequestAwareApp']);
await requireMarkers('src/evidence/evidenceTimeAttestationRequestServer.js','Request runtime composition',['createEvidenceAssuranceBundleAwareApp']);
